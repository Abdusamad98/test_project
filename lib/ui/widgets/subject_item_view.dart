...
class SubjectItemView extends StatelessWidget {
  const SubjectItemView(
      {super.key, required this.subjectModel, required this.onSubjectPressed});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(16), color: subjectModel.color),
        child: Row(
          children: [
            Expanded(
                child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 25),
                Text(
                  "Record: ${prefs.getInt(subjectModel.resultKey) ?? 0}/${subjectModel.questions.length}",
                  style: const TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.w600,
